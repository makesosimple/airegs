      ...
      <div className="aui-thread-welcome-center flex w-full grow flex-col items-center justify-center">
        <div className="aui-thread-welcome-message flex size-full flex-col justify-center px-4">
          ...
          <p className="aui-thread-welcome-message-inner fade-in slide-in-from-bottom-1 animate-in fill-mode-both text-muted-foreground text-xl delay-75 duration-200">
            Bankacılık düzenlemeleri hakkında size nasıl yardımcı olabilirim?
          </p>
        </div>
      </div>
      <ThreadSuggestions />
...
const SUGGESTIONS = [
  { title: "Konut kredisi LTV oranı", description: "nedir ve nasıl hesaplanır?" },
  { title: "Son kredi kartı düzenlemeleri", description: "neler değişti?" },
  { title: "Dijital bankacılık", description: "faaliyet esasları nelerdir?" },
  { title: "Sermaye yeterliliği oranı", description: "nasıl hesaplanır?" },
];
